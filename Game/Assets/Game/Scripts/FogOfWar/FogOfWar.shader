...
Properties {
	...
	_Leader1_Pos ("_Leader1_Pos",Vector) = (0,0,0,1)
	_Leader2_Pos ("_Leader2_Pos",Vector) = (0,0,0,1)
}
...
SubShader {
	...
	void surf (Input IN, inout SurfaceOutput o) {
		...
		float alpha = (1.0 - (baseColor.a + powerForPos(_Leader1_Pos, IN.location) +  powerForPos(_Leader2_Pos, IN.location) ) );	
